...
peer channel create -o orderer0.example.com:7050 -c ch1 -f Org0MSPanchors.tx --cafile $FABRIC_PATH/crypto/ordererOrganizations/example.com/orderers/orderer0.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
